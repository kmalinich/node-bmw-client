	...
	check_data : (data) => {
		...
		switch (data.msg[0]) {
			...
			case 0x21: // Update: Menu text
				data.command = 'upd';
				data.value   = 'menu text: '+Buffer.from(data.msg).slice(2).toString();
				break;
        ...
        data.value = 'display text, F/L: '+flags+'/'+layout+', \''+Buffer.from(data.msg).slice(4).toString().replace(/�/g, '°').slice(0, -1)+'\'';
				break;
        ...
        switch (data.msg[1]) {
          ...
          case 0x03 : layout = 'outside_temp';     break;
          case 0x04 : layout = 'consumption_1';    break;
          case 0x05 : layout = 'consumption_2';    break;
          case 0x06 : layout = 'range';            break;
          case 0x07 : layout = 'distance';         break;
          case 0x08 : layout = 'arrival';          break;
          case 0x09 : layout = 'limit';            break;
          case 0x0A : layout = 'average_speed';    break;
          case 0x0B : layout = 'obc_mode_0b';      break;
          case 0x0C : layout = 'memo';             break;
          case 0x0D : layout = 'code';             break;
          case 0x0E : layout = 'stopwatch';        break;
          case 0x0F : layout = 'timer_1';          break;
          case 0x10 : layout = 'timer_2';          break;
          case 0x11 : layout = 'aux_heating_off';  break;
          case 0x12 : layout = 'aux_heating_on';   break;
          case 0x13 : layout = 'aux_vent_off';     break;
          case 0x14 : layout = 'aux_vent_on';      break;
          case 0x15 : layout = 'end_stellmode';    break;
          case 0x16 : layout = 'emergency_disarm'; break;
          case 0x17 : layout = 'obc_mode_17';      break;
          case 0x18 : layout = 'obc_mode_18';      break;
          case 0x19 : layout = 'obc_mode_19';      break;
          case 0x1A : layout = 'interim_time';     break;
          case 0x1B : layout = 'aux_heat/vent';    break;
          case 0x1C : layout = 'obc_mode_1c';      break;
          case 0x1D : layout = 'obc_mode_1d';      break;
          case 0x1E : layout = 'obc_mode_1e';      break;
          case 0x1F : layout = 'test_mode';        break;
          case 0x24 : layout = 'checkcontrol';     break;
          case 0x40 : layout = 'display text';     break;
          case 0x50 : layout = 'cluster';          break;
          case 0x62 : layout = 'radio display';    break;
          default   : layout = 'unknown '+data.msg[1]; break;
        }
		...
		//	case 0x24: // Update: OBC text
		//		data.command = 'upd';
    //    data.value   = 'OBC text, '+Buffer.from(data.msg).slice(4).toString().replace(/�/g, '°');
		//		break;
