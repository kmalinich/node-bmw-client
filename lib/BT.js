...
module.exports = {
	...
	start : (start_callback = null) => {
		...
		log.module({ src : module_name, msg : 'Performing start' });
	...
	start_listeners : (start_listeners_callback = null) => {
		if (config.media.bluetooth === false) {
			if (typeof start_listeners_callback === 'function') start_listeners_callback();
			start_listeners_callback = undefined;
			return false;
		}
