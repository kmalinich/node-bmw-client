...
function decode_light_control_status(data) {
	...
	let parse = {
		...
		intensity_str : null,
		intensities   : {
			l1 : mask2.bit4  && !mask2.bit5 && !mask2.bit6 && !mask2.bit8,
			l2 : !mask2.bit4 &&  mask2.bit5 && !mask2.bit6 && !mask2.bit8,
			l3 : mask2.bit4  &&  mask2.bit5 && !mask2.bit6 && !mask2.bit8,
			l4 : !mask2.bit4 && !mask2.bit5 &&  mask2.bit6 && !mask2.bit8,
			l5 : mask2.bit4  && !mask2.bit5 &&  mask2.bit6 && !mask2.bit8,
			l6 : !mask2.bit4 &&  mask2.bit5 &&  mask2.bit6 && !mask2.bit8,
			l0 : !mask2.bit4 && !mask2.bit5 && !mask2.bit6 &&  mask2.bit8,
		},
